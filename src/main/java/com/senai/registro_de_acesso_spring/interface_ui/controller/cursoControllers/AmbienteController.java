...
import com.senai.registro_de_acesso_spring.application.service.cursoServices.AmbienteService;
...
public class AmbienteController {
    ...
    public ResponseEntity<List<AmbienteDTO>> listarAmbientes() {
        ambienteService.listarAmbientes();
        return ResponseEntity.ok().build();
    }
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Void> atualizarAmbiente(@PathVariable Long id, @RequestBody AmbienteDTO dto) {
